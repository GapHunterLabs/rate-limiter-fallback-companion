package dev.gaphunter.ratelimiterfallbackcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.ratelimiterfallbackcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.ratelimiterfallbackcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Rate Limiter Fallback Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33805-rate-limiter-fallback-companion/reviews"
